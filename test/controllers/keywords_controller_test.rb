...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { date: @keyword.date, from: @keyword.from, linkId: @keyword.linkId, smsId: @keyword.smsId, text: @keyword.text, to: @keyword.to }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { date: @keyword.date, from: @keyword.from, linkId: @keyword.linkId, smsId: @keyword.smsId, text: @keyword.text, to: @keyword.to }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
